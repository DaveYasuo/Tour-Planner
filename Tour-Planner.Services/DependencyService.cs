...
namespace Tour_Planner.Services
{
    public static class DependencyService
    {
        ...
        private static object GetInstance(Type type)
        {
            ...
            throw new KeyNotFoundException("No registration for " + type);
        }
        ...
        private static object CreateInstance(Type implementationType)
        {
            ...
            return Activator.CreateInstance(implementationType, dependencies) ?? throw new InvalidOperationException($"Cannot create Instance with type {implementationType}");
        }
