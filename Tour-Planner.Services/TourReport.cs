...
namespace Tour_Planner.Services
{
    ...
    {
        private readonly string _routeImagePath;
        private static readonly ILog Log = LogManager.GetLogger(MethodBase.GetCurrentMethod()!.DeclaringType);


        public TourReport(string routeImagePath)
        {
            _routeImagePath = routeImagePath;
        }
        public void CreateTourReport(Tour tour, List<TourLog> tourLogs)
        {
            var dialog = new SaveFileDialog
            {
                ...
                Filter = "Pdf Files| *.pdf" // Filter files by extension
            };
            ...
            PdfWriter writer = new(targetPdf);
            ...
            ImageData imageData = ImageDataFactory.Create(_routeImagePath + tour.ImagePath);
        ...
        public void CreateSummaryReport(List<Tour>? tours, List<TourLog>? tourLogs)
        {
            ...
            var dialog = new SaveFileDialog
            {
                FileName = "Summary", // Default file name
                DefaultExt = ".pdf", // Default file extension
                Filter = "Pdf Files| *.pdf" // Filter files by extension
            };
